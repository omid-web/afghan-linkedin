...
const user = authStore.getters.geUser;
...
function connectLinkedin() {
  window.open(
    "https://www.linkedin.com/oauth/v2/authorization?response_type=code&client_id=78y05l65holsi9&redirect_uri=http://localhost:3000/connect&scope=r_liteprofile%20r_emailaddress%20w_member_social", "_self"
  );
}
</script>
