...
function connectLinkedin() {
  window.open(
    "https://www.linkedin.com/oauth/v2/authorization?response_type=code&client_id=78y05l65holsi9&redirect_uri=http://localhost:3000&scope=r_liteprofile%20r_emailaddress%20w_member_social", "_self"
  );
}
</script>
...
<div class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
  <div class="max-w-md w-full space-y-8">
    ...
    <UserCardComponent v-for="u in users" :user="u" :key="u.timestamp" />
  </div>
</div>
</template>
